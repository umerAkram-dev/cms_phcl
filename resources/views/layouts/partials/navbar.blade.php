    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <div class="">
                ...
                <div class="d-flex justify-content-around justify-content-lg-end justify-content-md-end">
                    <p class="nav-link nav_links mb-0 mt-3">{{ $data['header_text'] ?? null }}</p>
                </div>
                <div class="d-lg-flex d-md-flex justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link nav_links nav_links_blue" href="{{ route('landing') }}">Home</a>
                    ...
                    <li class="nav-item dropdown"> <!-- Dropdown menu -->
                        <a class="nav-link nav_links dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Programs
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('admin.programhighlights','cooking_classes') }}">Cooking Classes</a>
                            <a class="dropdown-item" href="{{ route('admin.programhighlights', 'lifestyle_changes') }}">Lifestyle Changes</a>
                            <a class="dropdown-item" href="{{ route('admin.programhighlights', 'treatments') }}">Treatments</a>
